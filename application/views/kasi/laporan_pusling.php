...
<body id="page-top">
				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						<div class="card-header py-3">
							<h6 class="m-0 font-weight-bold text-primary">Tabel Laporan Pusling</h6>
						</div>
						...
						<div class="card-body">
                          ...
                          ?>
								...
								<a href="<?php echo base_url('kasi/laporan/pusling'); ?>" class="btn btn-danger">Reset Filter</a>
    ...
    if( ! empty($pusling)){
      ...
      foreach($pusling as $data){
        ...
        echo "<td><img src='".base_url("assets/images_laporan/".$data->gambar)."' width='150' height='100'></td>";
        echo "<td><a href='".base_url() . "home/cetak_laporan/" . $data->id_laporan ."'
										class='btn btn-sm btn-info' target='_blank'><i class='fa fa-print'></i></a></td>";
										echo "</tr>";
										$no++;
										}
										}
