...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url()?>landing_page/fancybox/jquery.fancybox.min.css">
                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                <ul id="nav">
                                    ...
                                    <li class="active"><a href="<?php echo site_url()?>galeri">Galeri</a></li>
      ...
      <div class="container">
        <div class="row mb-5 justify-content-center">
          <div class="col-md-8 text-center">
            <h2 class="text-black h1 site-section-heading text-center">Galeri</h2>
          </div>
        </div>
      </div>
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-6 col-lg-4">
            <a href="<?php echo base_url()?>assets/images_galeri/<?=$hasil->gambar?>" class="media-1 fancybox"  data-fancybox="gallery2" data-caption="<?=$hasil->keterangan?>">
              <img src="<?php echo base_url()?>assets/images_galeri/<?=$hasil->gambar?>" alt="Image" class="img-fluid" style="height: 400px;">
              <div class="media-1-content">
                <h4 style="color: white;"><?=$hasil->judul?></h4>
                <p class="category"><?=substr($hasil->keterangan, 100)?></p>
              </div>
            </a>
          </div>
            <?php }?>
