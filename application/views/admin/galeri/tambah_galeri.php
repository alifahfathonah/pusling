			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						<div class="card-body">
							<form method="POST" action="<?php echo site_url('admin/galeri/simpan')?>" enctype="multipart/form-data">
								...
								<div class="form-group">
									...
									<textarea id="ckeditor" name="keterangan" class="form-control ckeditor"></textarea><br />
									<span style="color: red;"><?=form_error('keterangan')?></span>
								</div>
								<div class="form-group">
