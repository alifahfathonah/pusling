						...
						<div class="card-body">
							<form method="POST" action="<?php echo site_url('admin/galeri/update')?>" enctype="multipart/form-data">
								<div class="form-group">
									...
									<input type="text" name="judul" class="form-control" value="<?php echo $galeri->judul ?>"
										placeholder="Masukkan Judul" required>
									<input type="hidden" value="<?php echo $galeri->id_galeri ?>" name="id_galeri">
								</div>
								<div class="form-group">
									<label for="text">Keterangan</label>
									<textarea id="ckeditor" name="keterangan" class="form-control ckeditor"
										required><?php echo $galeri->keterangan ?></textarea><br />
								</div>
								<div class="form-group">
									<label for="text">Image</label>
									<img style="width: 180px; height: 100px;"
										src="<?php echo base_url('assets/images_galeri/'.$galeri->gambar) ?>">
									<br>
									<br>
									<!-- file lama -->
									<input type="hidden" name="filelama" value="<?=$galeri->gambar?>">
									<!-- ID -->
								...
								<a href="<?php echo site_url()?>admin/galeri" class="btn btn-md btn-primary">Back</a>
							</form>
						</div>
					</div>
