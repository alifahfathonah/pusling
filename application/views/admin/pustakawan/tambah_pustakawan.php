			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						<div class="card-body">
							<form method="POST" action="<?php echo site_url('admin/pustakawan/simpan')?>"
								enctype="multipart/form-data">
								<input type="hidden" name="role" value="pustakawan">
								<div class="form-group>">
									<label for="text">Nama *</label>
									<input type="text" name="nama_pustakawan" value="<?=set_value('nama_pustakawan')?>"
								...
								<div class="form-group">
									...
									<input type="text" name="telp_pustakawan" value="<?=set_value('telp_pustakawan')?>"
								...
								<div class="form-group">
									...
									<textarea id="ckeditor" name="alamat_pustakawan"
										class="form-control"><?=set_value('alamat_pustakawan')?></textarea><br />
