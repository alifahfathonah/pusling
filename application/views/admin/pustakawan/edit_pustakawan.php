			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						<div class="card-body">
							<form method="POST" action="<?php echo site_url('admin/pustakawan/update')?>"
								enctype="multipart/form-data">
								<div class="form-group>">
									<label for="text">Nama *</label>
									<input type="text" name="nama_pustakawan" value="<?php echo $pustakawan->nama_pustakawan ?>"
										class="form-control" placeholder="Masukkan Nama" autofocus>
									<input type="hidden" value="<?php echo $pustakawan->id_pustakawan ?>" name="id_pustakawan">
								</div>
								<div class="form-group">
									<label for="text">No Telepon *</label>
									<input type="text" name="telp_pustakawan" value="<?php echo $pustakawan->telp_pustakawan ?>"
										class="form-control" placeholder="Masukkan No Telepon">
									<input type="hidden" value="<?php echo $pustakawan->id_pustakawan ?>" name="id_pustakawan">
								</div>
								<div class="form-group">
									<label for="text">Alamat *</label>
									<textarea id="ckeditor" name="alamat_pustakawan"
										class="form-control"><?php echo $pustakawan->alamat_pustakawan ?></textarea><br />
									<input type="hidden" value="<?php echo $pustakawan->id_pustakawan ?>" name="id_pustakawan">
								</div>
								<button type="submit" class="btn btn-md btn-success" name="submit">Simpan</button>
								<a href="<?php echo site_url()?>admin/pustakawan" class="btn btn-md btn-primary">Back</a>
							</form>
						</div>
					</div>
