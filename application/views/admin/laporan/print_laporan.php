...
<body>
	<?php
		...
		$qr['data'] = site_url('home/cetak_laporan/' . $data['id_laporan']);
		
		$qr['level'] = 'M';
		$qr['size'] = 4;
		$qr['savename'] = FCPATH.'assets/images/'.$data['id_laporan'].'.png';
	...
	<table width="100%" style="margin-top: 100px;" border="0" cellspacing="0">
		<tr>
			<td width="50%" align="center">
				<img src="<?= site_url('assets/images/' . $data['id_laporan']) .'.png' ?>" alt="">
			</td>
			<td width="50%">
