...
<body>
	...
	<table style="width: 100%;">
		<tr>
			<th style="width: 50px;" align="center"><img src="images/Indramayu.png" width="100px" height="100px;"
					style="padding-left: 100px;"></th>
			<th style="width: 920px;" align="center">
				<h3 align="center">LAPORAN PERPUSTAKAAN KELILING KABUPATEN INDRAMAYU</h3>
				<h5 align="center">Jl. MT Haryono Nomor 49 Indramayu - Jawa Barat</h5>
			</th>
		</tr>
	</table>
	<hr>
	...
	<table>
        ...
        echo "<td  class='garis' style='Word-wrap: break-Word; width: 30px; padding:5px;'>".$data->tot_pengunjung."</td>";
