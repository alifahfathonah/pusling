			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						<div class="card-body">
							<form method="POST" action="<?php echo site_url('admin/user/simpan')?>"
								enctype="multipart/form-data">
								<div class="form-group>">
									<label for="text">Nama *</label>
									<input type="text" name="nama_user" value="<?=set_value('nama_user')?>"
										class="form-control" placeholder="Masukkan Nama">
									<span style="color: red;"><?=form_error('nama_user')?></span>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<input type="Password" name="passconf" class="form-control"
										value="<?=set_value('passconf')?>" placeholder="Masukkan Konfirmasi Password">
								...
								<div class="form-group">
									...
									<select name="role" class="form-control">
										...
										<option value="superadmin"
											<?=set_value('role') == 'superadmin' ? "selected" : null?>>Super Admin
										</option>
										<option value="pustakawan"
											<?=set_value('role') == 'pustakawan' ? "selected" : null?>>Pustakawan
										</option>
										<option value="kasi" <?=set_value('role') == 'kasi' ? "selected" : null?>>Kepala
											Seksi</option>
										<option value="kabid" <?=set_value('role') == 'kabid' ? "selected" : null?>>
								...
								<a href="<?php echo site_url()?>admin/user" class="btn btn-md btn-primary">Back</a>
							</form>
						</div>
					</div>
