			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						<div class="card-body">
							<form method="POST" action="<?php echo site_url('admin/user/update')?>"
								enctype="multipart/form-data">
								<div class="form-group">
									<label for="text">Nama</label>
									<input type="text" name="nama_user" value="<?php echo $users->nama_user ?>"
										class="form-control" placeholder="Masukkan Nama User">
									<input type="hidden" value="<?php echo $users->id_users ?>" name="id_users">
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<select name="role" class="form-control">
										...
										<option value="pustakawan"
											<?= $users->role == 'pustakawan' ? 'selected' : '' ?>>
											Pustakawan
										</option>
										<option value="kasi" <?= $users->role == 'kasi' ? 'selected' : '' ?>>
											Kepala Seksi
										</option>
										<option value="kabid" <?= $users->role == 'kabid' ? 'selected' : '' ?>>
											Kepala Bidang
										</option>
									</select>
									<input type="hidden" value="<?php echo $users->id_users ?>" name="id_users"><br />
								</div>
