      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-body">
              <form method="POST" action="<?php echo site_url('admin/klasifikasi/simpan')?>" enctype="multipart/form-data">
              <div class="form-group">
                <label for="text">Klasifikasi</label>
                <input type="text" name="klasifikasi" class="form-control" value="<?=set_value('klasifikasi')?>" placeholder="Masukkan Klasifikasi"  autofocus>
              ...
              <a href="<?php echo site_url()?>admin/klasifikasi" class="btn btn-md btn-primary">Back</a>
            </form>
            </div>
          </div>
