      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-body">
              <form method="POST" action="<?php echo site_url('admin/klasifikasi/update')?>" enctype="multipart/form-data">
              <div class="form-group">
                <label for="text">Klasifikasi</label>
                <input type="text" name="klasifikasi" class="form-control" value="<?php echo $klasifikasi->klasifikasi ?>" placeholder="Masukkan Klasifikasi"  autofocus>
                <input type="hidden" value="<?php echo $klasifikasi->id_klasifikasi ?>" name="id_klasifikasi">
