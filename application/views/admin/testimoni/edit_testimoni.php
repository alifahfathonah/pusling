			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						<div class="card-body">
							<form method="POST" action="<?php echo site_url('admin/testimoni/update')?>"
								enctype="multipart/form-data">
								<div class="form-group">
									<label for="text">Nama</label>
									<input type="text" name="nama" class="form-control" value="<?php echo $testimoni->nama ?>"
										placeholder="Masukkan Nama" required>
								</div>
								<div class="form-group">
									<label for="text">Komentar</label>
									<textarea id="ckeditor" name="komentar" class="form-control ckeditor"
										required><?php echo $testimoni->komentar ?></textarea><br />
								</div>
								<div class="form-group">
									<label for="text">Jabatan</label>
									<input type="text" name="jabatan" class="form-control" value="<?php echo $testimoni->jabatan ?>"
										placeholder="Masukkan Jabatan" required>
								</div>
								<div class="form-group">
									<label for="text">Image</label>
									<img src="<?php echo base_url('assets/images_testimoni/'.$testimoni->gambar) ?>"
										style="height: 100px; width: 200px;">
									<br>
									<br>
									<!-- file lama -->
									<input type="hidden" name="filelama" value="<?=$testimoni->gambar?>">
									<!-- ID -->
