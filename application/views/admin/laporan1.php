  ...
  <div id="wrapper">
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?php echo site_url('admin/user')?>">Staf dan Pustakawan</a>
            <a class="collapse-item" href="<?php echo site_url('admin/pustakawan')?>">Asisten</a>
          </div>
        </div>
      </li>
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            ...
            <?php if($this->session->flashdata('hapus') == TRUE): ?>
              ...
              <a href="<?php echo $url_cetak; ?>" class="btn btn-success" style="margin-top: 20px; margin-left: 20px; margin-right: 20px; margin-bottom: 20px;">Cetak</a>
    ...
    if( ! empty($laporan)){
      ...
      foreach($laporan as $data){
        ...
        echo "<td>".$data->nama_ast."</td>";
        echo "<td>".$data->nama_sup."</td>";
        echo "<td>".$data->jenis_pusling."</td>";
        echo "<td>".$data->kode_kendaraan."</td>";
        echo "<td>".$data->alamat_lokasi."</td>";
        echo "<td>".$data->no_pengelola."</td>";
        echo "<td>".$data->tot_pengunjung."</td>";
        echo "<td>".$data->tot_lk."</td>";
        echo "<td>".$data->tot_pr."</td>";
        echo "<td><img src='".base_url("assets/images_laporan/".$data->gambar)."' width='100' height='100'></td>";
        echo "<td style='text-align: center;''>
        <a href='laporan/edit/$data->id_laporan' class='btn btn-sm btn-warning'><i class='fa fa-edit'></i></a>
        <a href='laporan/hapus/$data->id_laporan' class='btn btn-sm btn-danger'><i class='fa fa-trash'></i></a>
        </td>";
        echo "</tr>";
        $no++;
      }
