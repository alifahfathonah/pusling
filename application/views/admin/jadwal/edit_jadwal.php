...
<body id="page-top">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						<div class="card-body">
							<form method="POST" action="<?php echo site_url('admin/jadwal/update')?>"
								enctype="multipart/form-data">
								<div class="form-group">
									<label for="text">Waktu</label>
									<input type="datetime-local" name="waktu" class="form-control"
										value="<?php echo $jadwal->waktu ?>" placeholder="Masukkan Waktu">
								...
								<div class="form-group">
									...
									<input type="text" name="lokasi" value="<?php echo $jadwal->lokasi ?>"
								...
								<div class="form-group">
									...
									<select class="form-control" name="status" id="status" required>
										...
										<option <?php if($jadwal->status=="1"){echo "selected";} ?> value="1">Aktif
										</option>
										<option <?php if($jadwal->status=="0"){echo "selected";} ?> value="0">Tidak
											Aktif</option>
									</select>
								...
								<input id="latitude" name="latitude" value="<?= $jadwal->latitude ?>" type="text" />
								<label for="longitude">Longitude:</label>
								<input id="longitude" name="longitude" value="<?= $jadwal->longitude ?>" type="text" />
								<br>
	...
	<script>
		...
		if ("<?= $jadwal->latitude ?>" !== "") {
			var marker = L.marker(["<?= $jadwal->latitude  ?>", "<?= $jadwal->longitude ?>"], {
				draggable: true
			}).addTo(mymap);
		} else {
