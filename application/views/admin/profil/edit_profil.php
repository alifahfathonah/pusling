			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						<div class="card-body">
							<form method="POST" action="<?php echo site_url('admin/profil/update')?>" enctype="multipart/form-data">
								<div class="form-group">
									<label for="text">Judul</label>
									<input type="text" name="judul" class="form-control" value="<?php echo $profil->judul ?>"
										placeholder="Masukkan Judul" required>
									<input type="hidden" value="<?php echo $profil->id_profil ?>" name="id_profil">
								</div>
								<div class="form-group">
									<label for="text">Isi</label>
									<textarea id="ckeditor" name="isi" class="form-control ckeditor"
										required><?php echo $profil->isi ?></textarea><br />
								</div>
								<div class="form-group">
									<label for="text">Image</label>
									<img src="<?php echo base_url('assets/images_profil/'.$profil->gambar) ?>"
										style="height: 100px; width: 200px;">
									<br>
									<br>
									<!-- file lama -->
									<input type="hidden" name="filelama" value="<?=$profil->gambar?>">
									<!-- ID -->
								...
								<a href="<?php echo site_url()?>admin/profil" class="btn btn-md btn-primary">Back</a>
							</form>
						</div>
					</div>
