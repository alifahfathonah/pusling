			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						<div class="card-body">
							<form method="POST" action="<?php echo site_url('admin/kendaraan/simpan')?>"
								enctype="multipart/form-data">
								<div class="form-group">
									<label for="text">Kode Kendaraan</label>
									<input type="text" name="kode_kendaraan" class="form-control" value="<?=set_value('kode_kendaraan')?>"
										placeholder="Masukkan Kode Kendaraan" autofocus>
									<span style="color: red;"><?=form_error('kode_kendaraan')?></span>
								</div>
								<div class="form-group">
									<label>Jenis Kendaraan</label>
									<select class="form-control" name="jenis_kendaraan" value="<?=set_value('jenis_kendaraan')?>"
										id="jenis_kendaraan">
