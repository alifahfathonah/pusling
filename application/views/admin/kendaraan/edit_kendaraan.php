			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						<div class="card-body">
							<form method="POST" action="<?php echo site_url('admin/kendaraan/update')?>"
								enctype="multipart/form-data">
								<div class="form-group">
									<label for="text">Kode Kendaraan</label>
									<input type="text" name="kode_kendaraan" class="form-control"
										value="<?php echo $kendaraan->kode_kendaraan ?>" placeholder="Masukkan Kode Kendaraan" autofocus>
									<input type="hidden" value="<?php echo $kendaraan->id_kendaraan ?>" name="id_kendaraan">
								...
								<div class="form-group">
									...
									<select name="jenis_kendaraan" class="form-control">
										<option <?php if($select['jenis_kendaraan']=="Mobil"){echo "selected";} ?> value="Mobil">Mobil
										</option>
										<option <?php if($select['jenis_kendaraan']=="Motor"){echo "selected";} ?> value="Motor">Motor
										</option>
									</select><br />
								</div>
                ...
                <span style="color: red;"><?=form_error('klasifikasi')?></span>
								...
								<a href="<?php echo site_url()?>admin/kendaraan" class="btn btn-md btn-primary">Back</a>
							</form>
						</div>
					</div>
