			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						<div class="card-body">
							<form method="POST" action="<?php echo site_url('admin/buku/simpan')?>"
								enctype="multipart/form-data">
								<!-- 
								<div class="form-group">
									<label for="text">Kode Buku</label>
									<input type="text" name="kode_buku" class="form-control" value="<?=set_value('kode_buku')?>"
                 ...
                 -->
								...
								<div class="form-group">
									...
									<input type="text" name="pengarang" class="form-control"
										value="<?=set_value('pengarang')?>" placeholder="Masukkan Pengarang">
									<span style="color: red;"><?=form_error('pengarang')?></span>
								</div>
								<div class="form-group">
									<label for="text">Penerbit</label>
									<input type="text" name="penerbit" class="form-control"
										value="<?=set_value('penerbit')?>" placeholder="Masukkan Penerbit">
								...
								<div class="form-group">
									...
									<input type="text" name="tempat_terbit" class="form-control"
										value="<?=set_value('tempat_terbit')?>" placeholder="Masukkan Tempat Terbit">
									<span style="color: red;"><?=form_error('tempat_terbit')?></span>
								</div>
								<div class="form-group">
									<label for="text">Eksemplar</label>
									<input type="number" name="eksemplar" class="form-control"
										value="<?=set_value('eksemplar')?>" placeholder="Masukkan Eksemplar">
									<span style="color: red;"><?=form_error('eksemplar')?></span>
								</div>

								<div class="form-group">
									<label for="text">Klasifikasi</label>
									<input type="text" name="klasifikasi" class="form-control"
										value="<?=set_value('klasifikasi')?>" placeholder="Masukkan Klasifikasi">
								...
								<div class="form-group">
									...
									<input type="text" name="call_number" class="form-control"
										value="<?=set_value('call_number')?>" placeholder="Masukkan Call Number">
									<span style="color: red;"><?=form_error('call_number')?></span>
								</div>
